...
| ⬜️ | تصحيح إظهار تفاصيل المنتج | معالجة مشكلة عدم فتح شاشة تفاصيل المنتج عند الضغط على البطاقة | 2025-07-16 |         | fix/product-details-screen | ⬜️ | ⬜️  | مراجعة التنقل من ProductListScreen إلى ProductDetailsScreen |                 |
