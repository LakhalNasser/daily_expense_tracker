...
| -- | ------------------ | ------------------------------------------------- | ----------- | -- | --- | ---------------------------------------------------------------- | --------------------- |
| ⬜️ | هيكل التطبيق       | إعداد BottomNavigationBar للتنقل بين الشاشات      | -           | ⬜️ | ⬜️  | `BottomNavigationBar` + `PageView` أو `IndexedStack`             | `feature/main-screen` |
...
| ✅  | اسم المهمة | وصف المهمة                     | وقت التعديل | 🔍 | 🛠️ | ⚙️                                | 🔀                      |
| -- | ---------- | ------------------------------ | ----------- | -- | --- | --------------------------------- | ----------------------- |
| ✅  | PieChart   | توزيع المصاريف حسب التصنيف     | 2025-07-05 11:00    | ⬜️ | ⬜️  | `charts_flutter` أو `fl_chart`    | `feature/statistics-ui` |
